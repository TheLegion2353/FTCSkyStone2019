...
@Autonomous(name="Autonomous Park Diag")
public class autonomousRedStartRight extends LinearOpMode {
    ...
    public void bothWheels(double pos) {
        motorLeft.setTargetPosition((int)pos + motorLeft.getTargetPosition());
        motorRight.setTargetPosition((int)pos + motorRight.getTargetPosition());
    }
